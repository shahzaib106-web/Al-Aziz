...
function seed() {
  ...
  const data = {
    ...
    menu: [
      ...
      { id: 'm11', catId: 'c2', nameUr: 'چکن بریانی', nameEn: 'Chicken Biryani', desc: 'خاص مصالحوں اور اصلی چاولوں سے تیار ہماری اسپیشل چکن بریانی۔', price: 600, options: [{ label: 'Half', price: 350 }, { label: 'Full', price: 600 }], rating: 4.8, reviews: 230, image: '/img/biryani.jpg', stock: 40, available: true, recipe: { rice: 0.25, chicken: 0.25, spices: 0.02 } },
      // ---- Sp. Desi Murgha ----
    ...
    orders: [
      {
        ...
        customer: { name: 'Ali Raza', phone: '0304 6721962', address: 'House 5, Near Royal Crystal Marquee, Sahiwal' },
